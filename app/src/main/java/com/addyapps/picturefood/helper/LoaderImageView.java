...
public class LoaderImageView extends LinearLayout {
	...
	private static Drawable getDrawableFromUrl(final String url) throws IOException, MalformedURLException {
		...
		{
			String urlBackup = "https://upload.wikimedia.org/wikipedia/commons/thumb/6/6d/Good_Food_Display_-_NCI_Visuals_Online.jpg/1200px-Good_Food_Display_-_NCI_Visuals_Online.jpg";
			return Drawable.createFromStream(((java.io.InputStream) new java.net.URL(urlBackup).getContent()), "name");
